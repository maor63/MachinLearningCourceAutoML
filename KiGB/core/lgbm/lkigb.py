...
from KiGB.core.lgbm.utils import kigb_penalty_update
...
class LKiGB(LGBMModel, RegressorMixin):
    ...
    def __init__(self, max_depth=-1,
                 ...
                 objective='regression', boosting_type='gbdt', lamda=1, epsilon=0, advice=None, trees=50, min_data=None,
                 **kwargs):
    ...
    def fit(self, X, y=None):
        ...
        lgb_train = lgb.Dataset(X, y, free_raw_data=False, silent=True)
        ...
        for h in range(1, self.trees + 1):
            lgb_train = lgb.Dataset(X, y, free_raw_data=False, silent=True)  # Bug in Lightgbm, need to initialize data
